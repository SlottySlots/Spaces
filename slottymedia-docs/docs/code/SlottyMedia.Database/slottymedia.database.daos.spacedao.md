...
```csharp
public class SpaceDao : Supabase.Postgrest.Models.BaseModel
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → BaseModel → [SpaceDao](./slottymedia.database.daos.spacedao.md)
...
### **SpaceDao(Guid, String)**

The constructor with parameters.

```csharp
public SpaceDao(Guid creatorUserId, string forumTopic)
```
