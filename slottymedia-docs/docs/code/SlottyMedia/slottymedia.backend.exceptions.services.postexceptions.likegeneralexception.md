...
```csharp
public class LikeGeneralException : SlottyMedia.Backend.Exceptions.BaseException, System.Runtime.Serialization.ISerializable
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) → [BaseException](./slottymedia.backend.exceptions.baseexception.md) → [LikeGeneralException](./slottymedia.backend.exceptions.services.postexceptions.likegeneralexception.md)<br>
